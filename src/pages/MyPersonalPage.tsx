          ...
          <div className="tabContent">
                ...
                <div className="relative p-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 fitWidth">
                    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-2 border border-slate-700/50">
                      ...
                      <div className="text-md font-bold">500,000 TRT</div>
                    </div>
                    ...
                    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-2 border border-slate-700/50">
                      ...
                      <div className="text-md font-bold">12,345</div>
                    </div>
                    ...
                    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-2 border border-slate-700/50">
                      ...
                      <div className="text-md font-bold">14d 6h 23m</div>
                    </div>
                    ...
                    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-2 border border-slate-700/50">
                      ...
                      <div className="text-md font-bold">2,500 TRT</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className={`tabItem ${activeTab === 1 ? 'active' : ''}`}>
              ...
              <div className="p-4">
                ...
                <div className="space-y-3">
                  <div
                      className="group bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border transition-all border-emerald-500/30 bg-emerald-500/5">
                      <div className="flex justify-between items-start">
                        <div>
                            <div className="flex items-center gap-2"><span className="font-medium">Connect Wallet</span><span
                              className="text-xs px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400">Completed</span>
                            </div>
                            <p className="text-sm text-slate-400 mt-1">Connect your wallet to participate</p>
                        </div>
                        <div className="flex items-center gap-2 text-emerald-500">
                            <span className="text-sm font-medium">100 TRT</span>
                            <ExternalLink className="w-5 h-5 text-slate-400" />
                        </div>
                      </div>
                      <div className="mt-3">
                        <div className="h-1 bg-slate-700/50 rounded-full overflow-hidden">
                            <div className="h-full transition-all duration-500 rounded-full bg-emerald-500 w-full"></div>
                        </div>
                      </div>
                  </div>
                  <div
                      className="group bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border transition-all border-slate-700/50 hover:border-pink-500/30 hover:bg-pink-500/5">
                      <div className="flex justify-between items-start">
                        <div>
                            <div className="flex items-center gap-2"><span className="font-medium">Join Telegram</span></div>
                            <p className="text-sm text-slate-400 mt-1">Join our Telegram community</p>
                        </div>
                        <a href="https://t.me/traderate" target="_blank" rel="noopener noreferrer"
                      ...
                      <div className="mt-3">
                        <div className="h-1 bg-slate-700/50 rounded-full overflow-hidden">
                            <div
                              className="h-full transition-all duration-500 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 w-0 group-hover:w-full">
                            </div>
                        </div>
                      </div>
                  </div>
                  <div
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                            <div className="flex items-center gap-2"><span className="font-medium">Follow Twitter</span></div>
                            <p className="text-sm text-slate-400 mt-1">Follow and retweet our pinned post</p>
                        </div>
                        <a href="https://twitter.com/traderate" target="_blank" rel="noopener noreferrer"
                            className="p-2 rounded-lg bg-slate-700/50 hover:bg-slate-700 transition-colors">
                            <ExternalLink className="w-5 h-5 text-slate-400" />
                        </a>
                      </div>
                  ...
                  <div
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                            <div className="flex items-center gap-2"><span className="font-medium">Share Signal</span></div>
                            <p className="text-sm text-slate-400 mt-1">Share at least one trading signal</p>
                        </div>
                        <div className="flex items-center gap-2 text-pink-500">
                            <span className="text-sm font-medium">400 TRT</span>
                            <ExternalLink className="w-5 h-5 text-slate-400" />
                        </div>
                      </div>
                      <div className="mt-3">
            ...
            <div className={`tabItem ${activeTab === 2 ? 'active' : ''}`}>
              ...
              <div className="p-4">
                ...
                <div className="space-y-3">
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-emerald-500/30 bg-emerald-500/5">
                      <div className="flex items-start gap-4">
                        <div className="p-3 rounded-xl bg-yellow-500/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-star w-6 h-6 text-yellow-500">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-slate-400 mt-1">Among the first 1000 users to join</p>
                        </div>
                        <div className="text-right">
                            <div className="text-sm font-medium text-emerald-500">500 TRT</div>
                        </div>
                      </div>
                  </div>
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-slate-700/50">
                      <div className="flex items-start gap-4">
                        <div className="p-3 rounded-xl bg-emerald-500/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-target w-6 h-6 text-emerald-500">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <h4 className="font-medium">Signal Master</h4>
                            </div>
                            <p className="text-sm text-slate-400 mt-1">Create 10 successful trading signals</p>
                            <div className="mt-2">
                              <div className="flex justify-between text-sm mb-1"><span className="text-slate-400">Progress</span><span className="text-slate-400">7%</span></div>
                              <div className="h-1 bg-slate-700/50 rounded-full overflow-hidden">
                                  <div className="h-full bg-gradient-to-r from-pink-500 to-purple-600 rounded-full transition-all"></div>
                              </div>
                            </div>
                        </div>
                        <div className="text-right">
                            <div className="text-sm font-medium text-pink-500">1000 TRT</div>
                        </div>
                      </div>
                  </div>
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-slate-700/50">
                      <div className="flex items-start gap-4">
                        <div className="p-3 rounded-xl bg-blue-500/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-users w-6 h-6 text-blue-500">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-slate-400 mt-1">Reach 1000 followers</p>
                            <div className="mt-2">
                              <div className="flex justify-between text-sm mb-1"><span className="text-slate-400">Progress</span><span className="text-slate-400">456%</span></div>
                              <div className="h-1 bg-slate-700/50 rounded-full overflow-hidden">
                                  <div className="h-full bg-gradient-to-r from-pink-500 to-purple-600 rounded-full transition-all"></div>
                              </div>
                            </div>
                        ...
                        <div className="text-right">
                            <div className="text-sm font-medium text-pink-500">2000 TRT</div>
                        </div>
                      </div>
                  </div>
                  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-slate-700/50">
                      <div className="flex items-start gap-4">
                        <div className="p-3 rounded-xl bg-purple-500/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-trending-up w-6 h-6 text-purple-500">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <h4 className="font-medium">Trading Expert</h4>
                            </div>
                            <p className="text-sm text-slate-400 mt-1">Maintain 90% success rate for 30 days</p>
                            <div className="mt-2">
                              <div className="flex justify-between text-sm mb-1"><span className="text-slate-400">Progress</span><span className="text-slate-400">85%</span></div>
                              <div className="h-1 bg-slate-700/50 rounded-full overflow-hidden">
                                  <div className="h-full bg-gradient-to-r from-pink-500 to-purple-600 rounded-full transition-all"></div>
                              </div>
                            </div>
                        ...
                        <div className="text-right">
                            <div className="text-sm font-medium text-pink-500">5000 TRT</div>
                        </div>
                      </div>
                  </div>
                </div>
